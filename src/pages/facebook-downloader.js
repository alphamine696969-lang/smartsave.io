// ═══════════════════════════════════════════════════════════
// SmartSave.io — Facebook Downloader Page
// Dedicated SEO page + platform-themed hero.
// Mounts DownloaderEngine with platformContext: 'facebook'.
// ═══════════════════════════════════════════════════════════

import { mount } from '../engine/DownloaderEngine.js';
import { updateSEO, buildPlatformJsonLd } from '../engine/core/seoManager.js';

export function renderFacebookDownloader() {
  const desc = 'Download Facebook videos, Reels and clips for free. Paste any Facebook video URL and save in HD quality — no login required. Supports fb.watch links.';

  updateSEO({
    title: 'Facebook Video Downloader — HD, Free Online | SmartSave.io',
    description: desc,
  ...
  setTimeout(() => {
    ...
    if (root) mount(root, url, { id: 'facebook' });
  }, 0);

  return `
    <div class="platform-page platform-page--facebook">

      <!-- Platform Hero -->
      <section class="platform-hero" aria-label="Facebook downloader hero">
        ...
        <div class="platform-hero__content">
          ...
          <span class="platform-hero__label">Facebook Downloader</span>
          <h1 class="platform-hero__title">
            Download Facebook Videos<br/>
            <span class="platform-hero__title-accent">HD Quality, Instantly Free</span>
          </h1>
          <p class="platform-hero__desc">
            Paste any Facebook video, Reel, or Watch URL to download in full HD.<br/>
            Supports facebook.com, fb.watch, and mobile links — no account needed.
          </p>
          <div class="platform-hero__tags" role="list">
            <span class="platform-hero__tag" role="listitem">✓ Facebook Videos</span>
            <span class="platform-hero__tag" role="listitem">✓ FB Reels</span>
            <span class="platform-hero__tag" role="listitem">✓ fb.watch Links</span>
            <span class="platform-hero__tag" role="listitem">✓ HD Quality</span>
            <span class="platform-hero__tag" role="listitem">✓ No Login Required</span>
          </div>
        </div>
      </section>
      ...
      <section class="platform-howto section section--center">
        <div class="container">
          ...
          <h2 class="section__title">Download Facebook Videos in 3 Steps</h2>
          <div class="platform-steps">
            <div class="platform-step reveal">
              <div class="platform-step__num">1</div>
              <h3 class="platform-step__title">Copy the Video Link</h3>
              <p class="platform-step__desc">Find the Facebook video you want. Tap the three-dot menu (⋯) and select "Copy link" or copy the URL from your browser.</p>
            </div>
            <div class="platform-step reveal reveal-delay-1">
              <div class="platform-step__num">2</div>
              <h3 class="platform-step__title">Paste &amp; Detect</h3>
              <p class="platform-step__desc">Paste the link above. We automatically detect the video and prepare all available quality options for you.</p>
            </div>
            <div class="platform-step reveal reveal-delay-2">
              <div class="platform-step__num">3</div>
              <h3 class="platform-step__title">Download in HD</h3>
              <p class="platform-step__desc">Choose your preferred quality and download directly to your device — fast, free, and private.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="platform-faq section">
        <div class="container container--narrow">
          ...
          <h2 class="section__title">Facebook Downloader FAQ</h2>
          <div class="platform-faq__list">
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I download Facebook Reels?</summary>
              <p class="platform-faq__a">Yes! Paste any Facebook Reel URL and we extract the video in the highest available quality without watermarks.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Does it work with fb.watch short links?</summary>
              <p class="platform-faq__a">Absolutely. Both full facebook.com URLs and fb.watch short links are fully supported.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Do I need a Facebook account to download?</summary>
              <p class="platform-faq__a">No account needed on our side. Only publicly visible Facebook videos can be downloaded.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">What video quality can I get?</summary>
              <p class="platform-faq__a">We extract the highest available quality — typically HD (720p) or Full HD (1080p), depending on what the uploader provided.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I download private Facebook videos?</summary>
              <p class="platform-faq__a">No — only public videos are downloadable. Private or friends-only videos cannot be accessed by our service.</p>
            </details>
          </div>
        </div>
      </section>
