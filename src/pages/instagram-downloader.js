// ═══════════════════════════════════════════════════════════
// SmartSave.io — Instagram Downloader Page
...
export function renderInstagramDownloader() {
  const desc = 'Download Instagram Reels, Stories, posts and IGTV videos for free. No login required. Save Instagram videos and photos in HD quality instantly.';

  updateSEO({
    title: 'Instagram Downloader — Reels, Stories & Posts | SmartSave.io',
    description: desc,
  ...
  setTimeout(() => {
    ...
    if (root) mount(root, url, { id: 'instagram' });
  }, 0);

  return `
    <div class="platform-page platform-page--instagram">

      <!-- Platform Hero -->
      <section class="platform-hero" aria-label="Instagram downloader hero">
        ...
        <div class="platform-hero__content">
          <div class="platform-hero__icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" width="48" height="48">
              <defs>
                <linearGradient id="ig-page-grad" x1="0%" y1="100%" x2="100%" y2="0%">
              ...
              <path fill="url(#ig-page-grad)" d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/>
            </svg>
          </div>
          <span class="platform-hero__label">Instagram Downloader</span>
          <h1 class="platform-hero__title">
            Save Instagram Reels,<br/>
            <span class="platform-hero__title-accent">Stories &amp; Posts</span>
          </h1>
          <p class="platform-hero__desc">
            Paste any Instagram link to download in full HD.<br/>
            Works for Reels, Stories, posts, carousels and IGTV — no account needed.
          </p>
          <div class="platform-hero__tags" role="list">
            <span class="platform-hero__tag" role="listitem">✓ Instagram Reels</span>
            <span class="platform-hero__tag" role="listitem">✓ Stories</span>
            <span class="platform-hero__tag" role="listitem">✓ Posts &amp; Carousels</span>
            <span class="platform-hero__tag" role="listitem">✓ IGTV Videos</span>
      ...
      <section class="platform-howto section section--center">
        <div class="container">
          ...
          <h2 class="section__title">Download Instagram Content in 3 Steps</h2>
          <div class="platform-steps">
            <div class="platform-step">
              <div class="platform-step__num">1</div>
              <h3 class="platform-step__title">Open Instagram</h3>
              <p class="platform-step__desc">Find the Reel, Story, or post you want. Tap the three-dot menu and select "Copy Link".</p>
            </div>
            <div class="platform-step">
              <div class="platform-step__num">2</div>
              <h3 class="platform-step__title">Paste the Link</h3>
              <p class="platform-step__desc">Paste the Instagram URL above. We instantly detect the content type and prepare download options.</p>
            </div>
            <div class="platform-step">
              <div class="platform-step__num">3</div>
              <h3 class="platform-step__title">Download Instantly</h3>
              <p class="platform-step__desc">Choose MP4 video or JPEG/PNG image and download directly to your device in HD.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="platform-faq section">
        <div class="container container--narrow">
          ...
          <h2 class="section__title">Instagram Downloader FAQ</h2>
          <div class="platform-faq__list">
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I download Instagram Reels?</summary>
              <p class="platform-faq__a">Yes! Just paste the Reel URL. We extract the highest quality MP4 available.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I download Instagram Stories?</summary>
              <p class="platform-faq__a">Yes — paste the story URL and we'll handle the rest. Note: only public Stories are downloadable.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Do I need an Instagram account to use this?</summary>
              <p class="platform-faq__a">No account needed on your end. Only public Instagram content can be downloaded.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I download Instagram photos too?</summary>
              <p class="platform-faq__a">Yes — single images and carousel posts are supported. Switch to the "Images" tab to see available photo formats.</p>
            </details>
          </div>
        </div>
      </section>
