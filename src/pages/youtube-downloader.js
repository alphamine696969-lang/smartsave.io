...
// Mounts DownloaderEngine with platformContext: 'youtube'.
// ═══════════════════════════════════════════════════════════
...
export function renderYouTubeDownloader() {
  const desc = 'Download YouTube videos in HD, 4K, or extract MP3/M4A audio free. Supports YouTube Shorts, live streams, playlists & more. No login required.';
  ...
  setTimeout(() => {
    ...
    if (root) mount(root, url, { id: 'youtube' });
  }, 0);

  return `
    <div class="platform-page platform-page--youtube">

      <!-- Platform Hero -->
      <section class="platform-hero" aria-label="YouTube downloader hero">
        ...
        <div class="platform-hero__content">
          ...
          <span class="platform-hero__label">YouTube Downloader</span>
          <h1 class="platform-hero__title">
            Download YouTube Videos<br/>
            <span class="platform-hero__title-accent">Free, HD & Instant</span>
          </h1>
          <p class="platform-hero__desc">
            Paste any YouTube URL — we'll extract every available quality in seconds.<br/>
            Supports videos, Shorts, live streams, and MP3 audio extraction.
          </p>
          <div class="platform-hero__tags" role="list">
            <span class="platform-hero__tag" role="listitem">✓ Up to 4K Quality</span>
            <span class="platform-hero__tag" role="listitem">✓ MP3 &amp; M4A Audio</span>
            <span class="platform-hero__tag" role="listitem">✓ YouTube Shorts</span>
            <span class="platform-hero__tag" role="listitem">✓ Live Streams</span>
      ...
      <section class="platform-howto section section--center">
        <div class="container">
          ...
          <h2 class="section__title">Download YouTube in 3 Steps</h2>
          <div class="platform-steps">
            <div class="platform-step">
              <div class="platform-step__num">1</div>
              <h3 class="platform-step__title">Copy the Link</h3>
              <p class="platform-step__desc">Go to YouTube, right-click any video and tap "Copy video URL" or copy from the address bar.</p>
            </div>
            <div class="platform-step">
              <div class="platform-step__num">2</div>
              <h3 class="platform-step__title">Paste &amp; Detect</h3>
              <p class="platform-step__desc">Paste the link above. We automatically detect the video and show all available quality options.</p>
            </div>
            <div class="platform-step">
              <div class="platform-step__num">3</div>
              <h3 class="platform-step__title">Choose &amp; Download</h3>
              <p class="platform-step__desc">Pick your preferred quality — 4K, 1080p, 720p, or MP3 — and download in seconds.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="platform-faq section">
        <div class="container container--narrow">
          ...
          <h2 class="section__title">YouTube Downloader FAQ</h2>
          <div class="platform-faq__list">
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I download YouTube Shorts?</summary>
              <p class="platform-faq__a">Yes! Paste a YouTube Shorts URL and we'll detect it automatically. Shorts download as MP4 in their native vertical format.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I extract MP3 audio from YouTube?</summary>
              <p class="platform-faq__a">Absolutely. Switch to the "Audio Only" tab after pasting your link to see all available audio formats including MP3 and M4A.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">What's the highest quality available?</summary>
              <p class="platform-faq__a">We support up to 4K (2160p) where available. The "Best Quality" option automatically merges the highest video stream with the best audio track.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Is this free and does it require a login?</summary>
              <p class="platform-faq__a">100% free, no account, no signup. Just paste the link and download.</p>
            </details>
            <details class="platform-faq__item">
              <summary class="platform-faq__q">Can I download entire playlists?</summary>
              <p class="platform-faq__a">Currently SmartSave.io downloads individual videos. Paste each video's URL separately for best results.</p>
            </details>
          </div>
        </div>
      </section>
